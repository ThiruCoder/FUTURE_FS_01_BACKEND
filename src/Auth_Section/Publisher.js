...
import { AuthModel } from '../Database_Section/Models/AuthModel.js';
...
const UserLogin = async (req, res) => {
    try {
        ...
        if (!username?.trim() || !password?.trim()) {
            logger.warn('Username and Password is required.')
        ...
        if (!User) {
            logger.warn('Username is invalid, Please check and login')
        ...
        if (!isMatch) {
            logger.warn('Password is invalid, Please check and login')
